  ...
  app.innerHTML = `
    ...
    <section class="hero-section">
      <div class="hero-content fade-in">
        <img src="/images/logo.jpg" alt="Aarry Andaidasis Seed" class="hero-logo" />
        <h2 class="hero-title">AARRY ANDAIDASIS SEED SHOP</h2>
    ...
    <section class="about-section">
      <div class="about-content">
        <div class="about-text">
          <p><strong>Aarry Andaidasis Seed Shop</strong> nace de la pasion por las mejores geneticas cannabicas y la cultura del coffee shop de Amsterdam.</p>
        ...
        <img src="/images/logo.jpg" alt="Aarry Andaidasis" class="about-img" />
      </div>
...
const SHOP_EMAIL = 'info@aarryseeds.com';
...
function buildOrderText() {
  ...
  return `NUEVO PEDIDO - Aarry Andaidasis Seed Shop
=========================================
PRODUCTOS:
${items}
